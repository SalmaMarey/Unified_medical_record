...
class EyePaymentScreen extends StatefulWidget {
  const EyePaymentScreen({Key? key}) : super(key: key);

  @override
  State<EyePaymentScreen> createState() => _EyePaymentScreenState();
}

class _EyePaymentScreenState extends State<EyePaymentScreen> {
  @override
